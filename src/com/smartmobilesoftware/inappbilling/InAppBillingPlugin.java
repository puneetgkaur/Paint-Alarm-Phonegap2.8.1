...
public class InAppBillingPlugin extends CordovaPlugin {
	...
	/*private static final String publicKey = "";
	...
	// private String callbackId;
        private ButtonClickerObserver buttonClickerObserver;
               /*
                public InAppBillingPlugin(){
                        ButtonClickerObserver buttonClickerObserver = new ButtonClickerObserver(cordova.getActivity()); 
	...
	public boolean execute(String action, JSONArray data,  CallbackContext callbackContext) {
		...
		PluginResult pluginResult;
			...
			callbackContext.success();
                        ...
                        Log.v(TAG, "Reached1");
                        //buttonClickerObserver.callbackContext = callbackContext;
                        Log.v(TAG, "Reached2");
		       try{
                                Log.v(TAG, "Reached3");
		       		String productId = data.getString(0);
                                Log.v(TAG, "Reached4 productId : "+productId); 
                                
		       		PurchasingManager.initiatePurchaseRequest(productId);     
                                Log.v(TAG, "Called Purchaing Manager ");
               ...
               /*else if(INIT_STRING.equals(action) || OWN_ITEMS_STRING.equals(action) ||CHECK_SUBSCRIPTION_SUPPORTED_STRING.equals(action) || SUBSCRIBE_STRING.equals(action) ){
               }else{
                    result=false;
               }*/
		...
		if (INIT_STRING.equals(action)) {
			...
			try {
				...
				// Make the purchase
				BillingController.requestPurchase(cordova.getActivity(), productId, true , null);
			...
			try {
				...
				String productId = data.getString(0);
				// Make the purchase
				BillingController.requestSubscription(cordova.getActivity(), productId, true , null);
